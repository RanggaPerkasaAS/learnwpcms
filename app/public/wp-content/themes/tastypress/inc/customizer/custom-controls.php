 ...
 */
class Tastypress_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Tastypress_Dropdown_Category_Control extends WP_Customize_Control {
...
class Tastypress_Note_Control extends WP_Customize_Control {
...
class Tastypress_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Tastypress_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="tastypress-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Tastypress_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Tastypress_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="tastypress-sortable-list">
      ...
      ?>
      	<?php if ($options[$value.'_section_enable'] !== false ){?>
	        <li>
	            <input class="tastypress-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
	            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
	          <i class="dashicons dashicons-menu tastypress-drag-handle"></i>
	        </li>
        <?php }  endforeach;?>
        

        <li class="sortable-hideme">
          <input class="tastypress-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Tastypress_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
...
class Tastypress_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="tastypress-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'tastypress' ); ?>" class="tastypress-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
 ...
 * @since  1.0.0
 */
class Tastypress_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
...
class Tastypress_Customize_Column extends WP_Customize_Control {
	public $type = 'hr';
