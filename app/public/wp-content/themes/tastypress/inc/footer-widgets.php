...
class Tastypress_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'tastypress';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'tastypress' ), $i ),
...
// Initialize.
$tastypress_footer_widgets = new Tastypress_Footer_Widgets();
